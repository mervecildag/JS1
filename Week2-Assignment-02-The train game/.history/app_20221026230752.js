...
for (let i = 0; i < 4; i++) {
    ...
    if (randomNumber === guessedNumber) {
        ...
        let randomNumber = console.log("give a higher one")
        //let guessedNumber = Number(randomNumber);
    } else if (guessedNumber > randomNumber) {
        //let randomNumber = alert("give a lower one");
        let randomNumber = console.log("give a lower one.")
        //let guessedNumber = Number(randomNumber);
    } else if (randomNumber !== guessedNumber && i>3) {
        //alert("Your skor:" + point + " Sorry, you couldn't find your son.")
        //let randomNumber = console("Your skor:" + point + " Sorry, you couldn't find your son.")
    }
    let randomNumber = console.log("Your skor:" + point + " Sorry, you couldn't find your son.")
}